...
router.get('/overview', async function (req, res) {
    ...
    var q_transAnnualEarnings = await dbsql.db_trans.getAnnualEarnings(req.user[0]);
    ...
    var q_trans = { balance : q_transBalance, annualEarnings : q_transAnnualEarnings, expense : q_transExpense, income : q_transIncome};
    res.json(q_trans);
  });
