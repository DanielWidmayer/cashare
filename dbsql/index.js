...
module.exports.connect = async function () {
    con.connect(async function (err) {
        ...
        await db_user_group.create_table();

        // create TABLE user_category_table
        await db_user_cat.create_table();

        // create TABLE goal_table
        await db_goal.create_table();

        // create TABLE message_table
        await db_msg.create_table();

        // create TABLE transaction_table
        await db_trans.create_table();

        // create TABLE alert_table
        await db_alerts.create_table();
